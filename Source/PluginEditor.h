...
struct PathProducer
{
    PathProducer(SingleChannelSampleFifo<ASimpleEQAudioProcessor::BlockType>& scsf) :
...
private:
    SingleChannelSampleFifo<ASimpleEQAudioProcessor::BlockType>* leftChannelFifo;
...
struct ResponseCurveComponent : juce::Component,
    ...
    juce::Timer
{
    ResponseCurveComponent(ASimpleEQAudioProcessor&);
